...
@NgModule({
  declarations: [AppComponent, HomeComponent, EventsComponent, SchoolsComponent, SdaComponent, EventItemComponent, EventDetailComponent, ContactsComponent, PlanetariumComponent, TasteComponent, SundialsComponent],
